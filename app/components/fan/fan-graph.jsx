      ...
      <div className={fan.chartWrapper}>
        <svg className='chart' viewBox={`0,0,${width},${height}`} width="40vw" preserveAspectRatio="none">
          <g className='centralChart' transform={`translate(${margin.left}, ${margin.top})`} >
            ...
            <text x='185' y='50' fontFamily="Lato" fontWeight="400" fontSize="28" fill="#565656">Accelerometer Data</text>
            <text x='185' y='80' fontFamily="Lato" fontWeight="300" fontSize="16" fill="#565656">Measured in g's (gravitational force)</text>
          </g>
        </svg>
      </div>
    </div>
